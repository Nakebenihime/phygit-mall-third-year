...
import org.pds.ArchitectureArchUnitTest;
...
public class RepositoryRulesTest extends ArchitectureArchUnitTest {
    ...
    public void repository_classes_should_be_suffixed_as_such() {
        classes()
                .that().resideInAPackage("..org.pds.repository..")
    ...
    public void repositories_should_reside_in_a_repository_package() {
        classes()
                ...
                .should().resideInAPackage("..org.pds.repository..")
                .because("Repositories should reside in a package '..org.pds.repository..'")
                .check(javaClasses);
    }
